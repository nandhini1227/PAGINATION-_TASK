...
description.innerText="Pagination example";


let container = element("div", "class", "container");
let maindiv = element("div", "id", "main-div");
let navbar = element("nav", "id", "nav-bar");
let title = element("h1", "id", "title");
title.innerHTML = "DOM Pagination Task :";

function element(tagname, attname, attvalue) {
...
let btn_prev = btnele("button","type","button","btn","btn-outline-primary","id", "event-btn-prev","?Previous");
...
let btn_7 = btnele("button","type","button", "btn","btn-outline-primary","id","event-btn-7","7");

let btn_8 = btnele("button","type","button","btn","btn-outline-primary","id","event-btn-8","8");

let btn_9 = btnele( "button","type","button","btn","btn-outline-primary","id", "event-btn-9","9");

let btn_10 = btnele( "button","type","button","btn","btn-outline-primary", "id","event-btn-10","10");
...
table_body.setAttribute("id", "t-b");
...
async function paginationData() {
  ...
  try {
    ...
    // Previous Button!!
    let addEvent_prev = document.getElementById("event-btn-prev");
    addEvent_prev.addEventListener("click", () => {
      if (starting_value > 0) {
    ...
    function display_contents(Number_of_items) {
      let Table_body = document.getElementById("t-b");
...
ul_list.append(
  list_prev,list_first,list_1,list_2,list_3,list_4,list_5,list_6,list_7,list_8,list_9,list_10, list_next,list_last
);
list_prev.append(btn_prev);
